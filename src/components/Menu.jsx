...
const Menu = ({ categories, selectedCategory, onSelectCategory, toggleCart, cart }) => {
	...
	return (
		<div className="menu-labels">
			<button className={selectedCategory === 'all' ? 'active-menu-btn' : ''} onClick={() => onSelectCategory('all')}>
				All
			</button>
